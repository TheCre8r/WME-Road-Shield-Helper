...
(function() {
    ...
    // Version 2024.01.21+   Attempting to get update notificaiton working
    // Version bump
    // Version 2024.03.24.01 fixes state filtering
    ...
    function BuildBRTDiv() {
        ...
        */
        ...
        if (turnData && turnData.turnGuidance) {
            ...
            if (turnGuidance.tts) {document.querySelector("div.tippy-content > div > div.turn-header").textContent = "Turn to " + turnGuidance.tts}
