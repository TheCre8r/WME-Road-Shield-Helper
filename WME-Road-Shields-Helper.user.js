...
// Version 2021.12.30.001 - Pushed by jm6087
    ...
    function filterShields(state) {
        ...
        if (country == "Canada" || country == "United States" || country == "Puerto Rico") {
            log("Filtered " + state)
